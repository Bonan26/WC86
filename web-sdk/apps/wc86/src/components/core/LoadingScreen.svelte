...
<FadeContainer show={loadingType === 'start'}>
	<MainContainer>
		...
		>
			<!-- WC86 Wolf Club logo -->
			<SpineProvider key="loader" width={400}>
				<SpineTrack trackIndex={0} animationName={'wolf_club_logo'} loop timeScale={1} />
			</SpineProvider>
			{#if !context.stateApp.loaded}
				<LoadingProgress y={300} width={1967 * 0.2} height={346 * 0.2}>
